<template>
	<view>
		<view v-if="title" :class="[this.$u.bem('cell-group__title', { inset })]">{{ title }}</view>
		<view class="custom-class" :class="[this.$u.bem('cell-group', { inset }), border ? 'van-hairline--top-bottom' : '']"><slot /></view>
	</view>
</template>
